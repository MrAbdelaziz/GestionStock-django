# Generated by Django 3.0.6 on 2020-05-23 01:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantite', models.IntegerField()),
                ('fournisseur', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='API.Fournisseur')),
            ],
        ),
        migrations.CreateModel(
            name='Client',
            fields=[
                ...
                ('produits', models.ManyToManyField(through='API.Achat', to='API.Produit')),
            ],
        ),
        migrations.AddField(
            model_name='achat',
